...
<template>
        ...
        <div class="w-96">
            ...
            <div class="relative">
                ...
                <input type="search" id="search"
                    class="block w-full p-4 ps-10 pe-[4.5rem] text-sm text-gray-900 border border-gray-300 rounded-lg bg-gray-50 focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                    placeholder="Search" />

                <button type="button"
                    class="text-white absolute end-2.5 bottom-2.5 bg-indigo-600 hover:bg-indigo-700 ring-1 ring-slate-300 shadow font-medium rounded-lg text-sm px-4 py-2">Search</button>
            </div>
        </div>
    </div>
    ...
    <div class="relative overflow-x-auto border rounded-md ">
        <table class="w-full text-sm text-left rtl:text-right text-gray-500">
            ...
            <tbody>
                <tr v-for="(user, index) in data.data" :key="index"
                    class="bg-white border-b dark:bg-gray-800 dark:border-gray-700 border-t hover:bg-gray-100">
        ...
        <div class="flex items-center justify-betweenbg-white px-4 py-3 sm:px-6">
